...
public class ArrayDeque61BTest {
    ...
    public void removeFirstTest01() {
        ...
        arr.addLast(3);
        arr.removeFirst();
        assertThat(arr.toList()).containsExactly(2, 3).inOrder();
    }
    ...
    public void removeFirstTest03() {
        ...
        arr.removeFirst();
        arr.removeFirst();
        assertThat(arr.toList()).containsExactly(14, 15, 16).inOrder();
    }
    ...
    public void removeLast03(){
        ...
        arr.removeLast();
        arr.removeLast();
        assertThat(arr.toList()).containsExactly(22,18,8,4).inOrder();
    }
}
